    ...
    <div className="about-page container animate-fade-in">
      ...
      <div className="about-grid">
        <div className="about-text-card glass-card">
          ...
          <p>Welcome to Vignette Voyages, a next-generation travel platform built for modern adventurers. We combine personal storytelling with AI semantic NLP indexing so your travel searches find the most relevant, high-value recommendations.</p>
